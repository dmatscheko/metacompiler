...
function* sendInner() { var sa = yield 1; yield "a=" + sa; return "r"; }
function* sendOuter() { yield "v=" + (yield* sendInner()); }
var sg = sendOuter();
var sr1 = sg.next().value;
var sr2 = sg.next("S").value;
var sr3 = sg.next().value;
...
var clLog = [];
function* clG() { try { yield 1; yield 2; } finally { clLog.push("fin"); } }
var clA = clG();
...
var clL2 = [];
function* clInner() { try { yield 1; yield 2; } finally { clL2.push("in"); } }
function* clOuter() { try { yield* clInner(); } finally { clL2.push("out"); } }
var clB = clOuter();
